      ...
      <div className="mx-auto max-w-[1400px]">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-16">
          <div>
            ...
            <h2 className="display mt-2 text-[45px] leading-[0.9] text-paper sm:text-[74px]">
              WE&apos;RE FROM
              <br />
              <span className="text-acid">QUEENS</span>
            </h2>

            <p className="mt-6 max-w-lg text-[17px] leading-relaxed text-paper sm:text-[19px]">
              We started SLAPPZ because we wanted a pre-roll we&apos;d actually smoke
              ourselves — and we wanted it to come from here.
            </p>

            <div className="mt-4 max-w-lg space-y-3 text-[15px] leading-relaxed text-muted">
              <p>
