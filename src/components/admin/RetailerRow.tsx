    ...
    >
      <div className="min-w-[220px] flex-1">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {!retailer.active && (
            <span className="meta border border-magenta px-1.5 py-0.5 text-[12px] text-magenta">
              INACTIVE
            </span>
          )}
          {retailer.featured && (
        ...
        <p className="meta mt-1.5 flex flex-wrap gap-x-3 gap-y-1 text-[13px] text-muted">
